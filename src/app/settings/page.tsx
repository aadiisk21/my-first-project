...
import { BellIcon, SwatchIcon, GlobeAltIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
      ...
      <div className="trading-card p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between pb-4 border-b border-border">
            <div>
              <div className="font-medium text-foreground">Notifications Enabled</div>
              <div className="text-sm text-muted-foreground">Receive all notifications</div>
            </div>
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Get notified via email</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Get push notifications on your device</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Notify on price movements</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Notify when signals are generated</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Require confirmation for orders</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
